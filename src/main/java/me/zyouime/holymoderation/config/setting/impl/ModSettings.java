...
public final class ModSettings extends AbstractSettings {
    ...
    public final Setting<String> apiToken = registerSetting(Setting.of("apiToken", SettingsTypes.STRING, "", "Токен журнала"));
    public final Setting<Boolean> copyButton = registerSetting(Setting.of("copyButton", SettingsTypes.BOOLEAN, false, "Кнопка копирования"));
    public final Setting<String> copyButtonText = registerSetting(Setting.of("copyButtonText", SettingsTypes.STRING, "§f§l[§a§lcopy§f§l]", "Текст кнопки копирования"));
    public final Setting<String> playerMarker = registerSetting(Setting.of("playerMarker", SettingsTypes.STRING, "§d§l[CHECK]", "Метка игрока на проверке"));
    public final Setting<Boolean> autoVanish = registerSetting(Setting.of("autoVanish", SettingsTypes.BOOLEAN, true, "Авто /v"));
    public final Setting<Boolean> autoFly = registerSetting(Setting.of("autoFly", SettingsTypes.BOOLEAN, false, "Авто /fly"));
    public final Setting<Boolean> autoGm3 = registerSetting(Setting.of("autoGm3", SettingsTypes.BOOLEAN, false, "Авто /gm 3"));
    public final Setting<Boolean> autoHacAlerts = registerSetting(Setting.of("autoHacAlerts", SettingsTypes.BOOLEAN, false, "Авто /hac alerts"));
    public final Setting<Boolean> autoGod = registerSetting(Setting.of("autoGod", SettingsTypes.BOOLEAN, false, "Авто /god"));
    ...
    public final Setting<Integer> spyHudScale = registerSetting(Setting.of("spyHudScale", SettingsTypes.INTEGER, 100, "Масштаб плашки слежки, %"));
    ...
    public final Setting<Integer> notificationScale = registerSetting(Setting.of("notificationScale", SettingsTypes.INTEGER, 100, "Масштаб уведомлений, %"));
    public final Setting<Boolean> checkoutHudEnabled = registerSetting(Setting.of("checkoutHudEnabled", SettingsTypes.BOOLEAN, true, "Плашка проверки"));
    public final Setting<Integer> checkoutHudScale = registerSetting(Setting.of("checkoutHudScale", SettingsTypes.INTEGER, 100, "Масштаб плашки проверки, %"));
