...
public final class SettingsCatalog {
    ...
    public static List<SettingEntry<?>> of(ModSettings settings) {
        return List.of(
                new ToggleEntry("autovanish", Agreement.MASCULINE, settings.autoVanish),
                new ToggleEntry("autofly", Agreement.MASCULINE, settings.autoFly),
                new ToggleEntry("autogm3", Agreement.MASCULINE, settings.autoGm3),
                new ToggleEntry("autogod", Agreement.MASCULINE, settings.autoGod),
                new ToggleEntry("autoha", Agreement.PLURAL, settings.autoHacAlerts),
                new ToggleEntry("autodupeip", Agreement.MASCULINE, settings.dupeIp),
                new ToggleEntry("autotp", Agreement.MASCULINE, settings.autoCheckoutTp),
                new ToggleEntry("autospytp", Agreement.MASCULINE, settings.autoSpyTp),
//                new ToggleEntry("autoban", "Автоматический бан после проверки", Agreement.MASCULINE, settings.autoBan),
                new ToggleEntry("autocopy", Agreement.NEUTER, settings.autoAnyDesk),
...
//                new TextEntry("obspassword", "Пароль OBS", settings.obsPassword, MAX_TEXT_LENGTH, true),
                new NumberEntry("checkouthudscale", settings.checkoutHudScale, HUD_SCALE_MIN, HUD_SCALE_MAX),
                new NumberEntry("spydelay", settings.spyDelay, SPY_DELAY_MIN, SPY_DELAY_MAX));
